...
class AdminProductoAdapter(
...
) : RecyclerView.Adapter<AdminProductoAdapter.AdminProductoViewHolder>() {

    var onEditar: ((Producto) -> Unit)? = null
    var onEliminar: ((Producto) -> Unit)? = null
    ...
    override fun onBindViewHolder(holder: AdminProductoViewHolder, position: Int) {
        ...
        holder.txtNombre.text = producto.nombreCorto?.ifEmpty { producto.nombre }
